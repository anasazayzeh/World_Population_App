...
# Read the CSV data
df = pd.read_csv(r"C:\Users\anas\OneDrive\المستندات\AUB MASTERS PROGRAM\ACADEMIA\DATA VISUALIZATION\ANAS AZAYZEH - HW 03\World Population Growth.csv", dtype={"Year": object})
